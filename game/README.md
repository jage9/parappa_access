...
PaRappa the Rapper (SCUS-94183) dump here. The current launcher expects:
...
rename an ISO to IMG or convert your dump just to pass this check. A file
picker and validation for other formats remain future setup work.
